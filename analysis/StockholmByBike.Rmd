...
This would however also include motorways and other routes that are exclusively or preferably usable by vehicles. Thus, we would like to use a more bicycle-friendly query...
...
if (!file.exists ("data/Silicate_sthlm_map_cycle.Rds") |
  ...
  saveRDS(trim_osmdata(sthlm_map_cycle_sf,getbb("SE-AB", format_out="polygon"),exclude=TRUE), file = "data/SimpleFeatures_sthlm_map_cycle.Rds")
...
if (exists("sthlm_map_cycle_sf")) {
  library("mapdeck")
  set_token (Sys.getenv("MAPBOXTOKEN"))
