...
import { Logo, LogoBlank, Table, DataTable, Column} from './components'
...
<Image
  src="http://localhost:8081/scilifelab/scilifelabtraffic.jpg"
  style={{
    display: 'flex',
    alignItems: 'center',
...
<Image
  src="http://localhost:8081/photos/muensterprinzipalmarkt.jpg"
  style={{
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
...
<Image
  src="http://localhost:8081/img/triumphuspacis.jpg"
  style={{
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
...
<Image
  src="http://localhost:8081/photos/muensterluftbild.jpg"
  style={{
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
...
<Image
  src="http://localhost:8081/photos/muensterpromenade.jpg"
  style={{
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
...
```r 1:2 title="An overpass API query"
$bbox
[1] "59.1651172,17.9110935,59.4851172,18.2310935"
...
## Selecting features
  <sub>No motorways</sub>
<Image
  src="http://localhost:8081/maps/tomtebodakurvan.png"
  style={{
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
...
## Selecting features
  <sub>Cycleroutes next to main roads</sub>
<Image
  src="http://localhost:8081/maps/vaesterbron.png"
  style={{
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
...
title="Deck.gl for biology"></iframe>
...
set_token (Sys.getenv("MAPBOX_TOKEN"))
  mapdeck (style = 'mapbox://styles/mapbox/light-v9') %>%
    add_path (data = sthlm_map_cycle_sf$osm_lines,
        stroke_width = 1,
...
<Image
  src="http://localhost:8081/maps/stockholmmapenlarge.png"
  style={{
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
...
<Image src="http://localhost:8081/img/steep.svg"
  style={{
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
...
<Image src="http://localhost:8081/img/mollweideprojection.jpg"
  style={{
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
...
<Image src="http://localhost:8081/img/millerprojection.svg"
  style={{
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
...
<Table>
  <Column>
    <Image src="http://localhost:8081/img/7_bridges.svg"
    style={{
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  <Column>
    <Image src="http://localhost:8081/img/koeningsberg-graph.svg"
    style={{
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
